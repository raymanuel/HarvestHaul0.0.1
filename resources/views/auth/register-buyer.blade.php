        ...
        <div class="form-group pt-1">
            <label class="flex items-start gap-3 cursor-pointer p-3 rounded-xl bg-[#EEF0EB]/40 border border-[#16283C]/10">
                ...
                <span class="text-xs text-slate-500 leading-relaxed">
                    I agree to the
                    <a href="{{ route('legal.terms') }}" onclick="event.preventDefault(); openLegalModal('{{ route('legal.terms') }}')" class="inline-flex items-center gap-1 px-2.5 py-1 rounded-xl bg-[#16283C]/10 text-[#16283C] font-semibold hover:bg-[#16283C]/20 transition-all text-[11px]">Terms & Conditions <span style="font-size:10px;">←—</span></a>
                    and
                    <a href="{{ route('legal.privacy') }}" onclick="event.preventDefault(); openLegalModal('{{ route('legal.privacy') }}')" class="inline-flex items-center gap-1 px-2.5 py-1 rounded-xl bg-[#16283C]/10 text-[#16283C] font-semibold hover:bg-[#16283C]/20 transition-all text-[11px]">Privacy Policy <span style="font-size:10px;">←—</span></a>.
                </span>
            </label>
