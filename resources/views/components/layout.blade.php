        ...
        <div id="main-wrapper" class="main-wrapper flex-1 lg:pl-64 min-w-0 flex flex-col min-h-screen">
            ...
            <nav id="top-navbar" class="top-navbar hidden lg:flex sticky top-0 z-30 h-20 bg-white border-b border-slate-200/80 px-8 items-center justify-between shadow-sm">
                ...
                <div class="flex items-center gap-6 select-none">
                    <!-- Notifications button simulation -->
                    <div class="relative w-10 h-10 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-500 hover:text-slate-800 transition cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                        </svg>
                        <span class="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-emerald-500 animate-ping"></span>
                    </div>
