<x-guest-layout>
    ...
    <div class="text-center mb-10 max-w-xl mx-auto">
        ...
        <a href="/" class="flex justify-center items-center gap-2 mb-4 group">
            <div class="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#3A7D44] to-[#2E6336] flex items-center justify-center text-white shadow group-hover:scale-105 transition duration-300">
            ...
            <span class="text-xl font-bold tracking-tight bg-gradient-to-r from-[#3A7D44] to-[#2E6336] bg-clip-text text-transparent heading-font">HarvestHaul</span>
        </a>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl mx-auto">
        ...
        <a href="{{ route('register.role', 'farmer') }}"
           class="flex flex-col items-center p-6 bg-white border border-[#3A7D44]/10 hover:border-[#3A7D44]/30 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 no-underline text-center group">
            <div class="w-14 h-14 rounded-2xl bg-[#EFF2E9] flex items-center justify-center text-[#3A7D44] mb-6 group-hover:scale-110 group-hover:bg-[#3A7D44] group-hover:text-white transition-all duration-300">
            ...
            <div class="w-full mt-auto py-2 bg-[#EFF2E9] text-[#3A7D44] text-xs font-bold rounded-xl group-hover:bg-[#3A7D44] group-hover:text-white transition duration-300">
                Register as Farmer →
            </div>
        </a>
        ...
        <a href="{{ route('register.role', 'logistics_partner') }}"
           class="flex flex-col items-center p-6 bg-white border border-[#3A7D44]/10 hover:border-[#2E6336]/30 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 no-underline text-center group">
            <div class="w-14 h-14 rounded-2xl bg-[#EFF2E9] flex items-center justify-center text-[#2E6336] mb-6 group-hover:scale-110 group-hover:bg-[#2E6336] group-hover:text-white transition-all duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
            ...
            <p class="text-[10px] text-amber-600 font-semibold mt-1 mb-6">
                ⓘ Includes buyer capabilities — cooperatives with trucks choose this, not Buyer.
            </p>
            <div class="w-full mt-auto py-2 bg-[#EFF2E9] text-[#2E6336] text-xs font-bold rounded-xl group-hover:bg-[#2E6336] group-hover:text-white transition duration-300">
    ...
    <div class="mt-10 pt-5 border-t border-slate-100 text-center flex flex-col sm:flex-row justify-between gap-3 text-xs max-w-3xl mx-auto">
        <span class="text-slate-500 font-semibold mx-auto sm:mx-0">
            ...
            <a href="{{ route('login') }}" class="text-[#3A7D44] hover:text-[#3A7D44]/80 font-bold hover:underline">Log in here</a>
        </span>
