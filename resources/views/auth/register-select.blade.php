    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl mx-auto">
        ...
        <a href="{{ route('register.role', 'farmer') }}"
           class="flex flex-col items-center p-6 bg-white border border-[#16283C]/10 hover:border-[#16283C]/30 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 no-underline text-center group">
            <div class="w-14 h-14 rounded-2xl bg-[#f5f3ff] flex items-center justify-center text-[#16283C] mb-6 group-hover:scale-110 group-hover:bg-[#16283C] group-hover:text-white transition-all duration-300">
            ...
            <div class="w-full mt-auto py-2 bg-[#f5f3ff] text-[#16283C] text-xs font-bold rounded-xl group-hover:bg-[#16283C] group-hover:text-white transition duration-300">
                Register as Farmer →
            </div>
        </a>
        ...
        <a href="{{ route('register.role', 'logistics_partner') }}"
           class="flex flex-col items-center p-6 bg-white border border-[#16283C]/10 hover:border-[#0E1620]/30 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 no-underline text-center group">
            <div class="w-14 h-14 rounded-2xl bg-[#f5f3ff] flex items-center justify-center text-[#0E1620] mb-6 group-hover:scale-110 group-hover:bg-[#0E1620] group-hover:text-white transition-all duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
            ...
            <div class="w-full mt-auto py-2 bg-[#f5f3ff] text-[#0E1620] text-xs font-bold rounded-xl group-hover:bg-[#0E1620] group-hover:text-white transition duration-300">
