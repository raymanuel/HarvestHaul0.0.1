    ...
    @if ($errors->any())
        <div class="mb-6 p-4 bg-[var(--color-error-bg)] border border-[var(--color-error-border)] rounded-xl">
            <div class="flex items-start gap-2.5">
                <span class="text-[var(--color-error-text)] mt-0.5 text-xs"><x-icon name="warning" class="w-4 h-4" /></span>
        ...
        <div class="form-group pt-1">
            <label class="flex items-start gap-3 cursor-pointer p-3 rounded-xl bg-[#EEF0EB]/40 border border-[#16283C]/10">
                ...
                <span class="text-xs text-slate-500 leading-relaxed">
                    I agree to the
                    <a href="{{ route('legal.terms') }}" onclick="event.preventDefault(); openLegalModal('{{ route('legal.terms') }}')" class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#16283C]/10 text-[#16283C] font-semibold hover:bg-[#16283C]/20 transition-all text-[11px]">Terms & Conditions <span style="font-size:10px;">←—</span></a>
                    and
                    <a href="{{ route('legal.privacy') }}" onclick="event.preventDefault(); openLegalModal('{{ route('legal.privacy') }}')" class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#16283C]/10 text-[#16283C] font-semibold hover:bg-[#16283C]/20 transition-all text-[11px]">Privacy Policy <span style="font-size:10px;">←—</span></a>.
                </span>
            </label>
