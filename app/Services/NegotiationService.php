...
class NegotiationService
{
     ...
     *
     * @return array{message: NegotiationMessage, negotiated_price: float, negotiated_volume: float}
     */
    public function proposeTerms(Negotiation $negotiation, User $user, float $price, float $volume): array
    {
