                                ...
                                <tr>
                                    ...
                                    <td class="py-4 px-3">
                                        @if($driver->identity_verified)
                                            <span class="bg-[#16283C]/10 dark:bg-[#16283C]/10 text-[#16283C] dark:text-[#D7BC7A] text-[10px] font-bold px-2.5 py-1 rounded-lg uppercase tracking-wide">Verified</span>
                                        ...
                                        @else
                                            <span class="bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 text-[10px] font-bold px-2.5 py-1 rounded-lg uppercase tracking-wide">—</span>
                                        @endif
                                    </td>
                                    <td class="py-4 px-3">
