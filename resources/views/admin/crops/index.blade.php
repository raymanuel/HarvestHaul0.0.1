<x-layout>
                            ...
                            <div class="crop-row paginate-item border-slate-50 dark:border-slate-700/30"
                                ...
                                <div class="pagination-controls flex items-center justify-between px-6 py-2 pl-20 bg-slate-50/30 dark:bg-slate-900/20 border-t border-slate-100 dark:border-slate-700/30">
                                    ...
                                    <div class="flex items-center gap-1">
                                        <button type="button" class="pagination-prev inline-flex items-center justify-center w-7 h-7 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 text-[10px] font-bold transition disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer" title="Previous"><</button>
                                        <button type="button" class="pagination-next inline-flex items-center justify-center w-7 h-7 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 text-[10px] font-bold transition disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer" title="Next">></button>
                                    </div>
                                </div>
                                @endif
    ...
    <script>
        ...
        function confirmDeleteVariety(id, name) {
            document.getElementById('delete-confirm-message').textContent =
                `Delete variety "${name}"? This will fail if active harvest posts reference it.`;
