<x-register-layout maxWidth="480px">
    ...
    <div class="mb-8 text-center">
        ...
        <h2 class="text-xl font-bold text-slate-800 heading-font tracking-tight">Buyer Registration</h2>
        <p class="text-xs text-slate-500 mt-1.5 font-semibold">Create your business buyer account to browse verified cooperatives and place orders.</p>
    </div>
    ...
    <form action="{{ route('register.store') }}" method="POST" class="space-y-4">
        ...
        <div class="form-group">
            <label class="text-xs font-bold text-slate-700 block mb-1.5">Business Name *</label>
            <input type="text" name="business_name" placeholder="e.g. MetroMart Fresh Produce" required value="{{ old('business_name') }}"
        ...
        {{-- CONTACT PERSON --}}
        <div class="form-group">
            <label class="text-xs font-bold text-slate-700 block mb-1.5">Contact Person *</label>
            <input type="text" name="contact_person" placeholder="Full Name" required value="{{ old('contact_person') }}"
                class="px-4 py-3 w-full bg-white/80 border border-[#16283C]/15 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#16283C]/10 focus:border-[#16283C] transition">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="tel" inputmode="tel" name="phone" required value="{{ old('phone') }}" autocomplete="tel"
                class="px-4 py-3 w-full bg-white/80 border border-[#16283C]/15 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#16283C]/10 focus:border-[#16283C] transition">
        </div>

        {{-- DELIVERY ADDRESS --}}
        <div class="form-group">
            <label class="text-xs font-bold text-slate-700 block mb-1.5">Business Address *</label>
            <textarea name="business_address" rows="2" required
                class="px-4 py-3 w-full bg-white/80 border border-[#16283C]/15 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#16283C]/10 focus:border-[#16283C] transition">{{ old('business_address') }}</textarea>
        </div>

        {{-- BUSINESS INFORMATION --}}
        <div class="form-group">
            <label class="text-xs font-bold text-slate-700 block mb-1.5">Business Information (optional)</label>
            <textarea name="business_information" rows="2" placeholder="What does your business buy/sell? Anything cooperatives should know."
                class="px-4 py-3 w-full bg-white/80 border border-[#16283C]/15 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#16283C]/10 focus:border-[#16283C] transition">{{ old('business_information') }}</textarea>
        </div>
