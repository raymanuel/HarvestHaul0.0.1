                            ...
                            <td class="px-5 py-3 text-right">
                                <form method="POST" action="{{ route('admin.baseline-price', $crop) }}" class="inline-flex items-center gap-2">
                                    ...
                                    <input type="number" name="baseline_price_per_kg" step="0.01" min="0.01"
                                           ...
                                           placeholder="₱/kg"
                                           class="w-24 text-right text-xs border border-slate-200 dark:border-slate-600 rounded-xl px-2 py-1.5 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 focus:ring-2 focus:ring-[#16283C]/30 focus:border-[#16283C]">
                                    <button type="submit"
                                            class="text-[10px] font-bold uppercase px-2.5 py-1.5 bg-[#16283C]/10 dark:bg-[#16283C]/10 text-[#16283C] dark:text-[#D7BC7A] border border-[#16283C]/20 dark:border-[#16283C]/20 rounded-xl hover:bg-[#16283C]/15 hover:bg-[#16283C]/20 transition cursor-pointer">
                                        Save
                                    </button>
                                </form>
                            </td>
