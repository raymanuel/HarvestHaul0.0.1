<div class="w-full">
    ...
    <div class="report-grid">
        ...
        <div class="report-widget">
            <span class="text-4xl mb-3 block">💰</span>
            <h3 class="font-bold text-gray-400 text-sm uppercase tracking-wider">Pooling Savings</h3>
            <p class="text-3xl font-black text-gray-900 mt-2">₱0.00</p>
            <div class="mt-6 pt-4 border-t border-gray-100">
                <a href="#" class="text-[#2D8A37] font-bold text-sm hover:underline">Savings breakdown →</a>
            </div>
        </div>
