...
<head>
    ...
    <title>Privacy Policy — HarvestHaul</title>    <link rel="stylesheet" href="/fonts/fonts.css" />
    <style>
...
<body class="overflow-x-hidden">
    <div class="container">
        ...
        <ul>
            ...
            <li><strong>Usage Data:</strong> Post activity, transaction history, chat messages, and GPS location during active trips.</li>
        ...
        <ul>
            ...
            <li>To facilitate crop posts, negotiations, logistics pooling, and deliveries</li>
        ...
        <ul>
            <li>Farmers' posts are visible to logistics partners and buyers</li>
