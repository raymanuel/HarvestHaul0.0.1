    ...
    <header id="main-header" class="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex justify-between items-center">
            <a href="/" class="flex items-center gap-2.5">
                <div class="w-9 h-9 rounded-md bg-white border border-slate-200 flex items-center justify-center">
                    <x-brand-logo class="w-5 h-5 text-[var(--color-brand-green)]" style="filter: drop-shadow(0.6px 1px 0.8px rgba(14, 22, 32,0.45));" />
                </div>
            ...
            <div class="hidden md:flex items-center gap-3">
                @if (Route::has('login'))
                    @auth
                        <a href="{{ url('/dashboard') }}" class="px-4 py-2 bg-[#BFA05A] text-[#17202B] rounded-xl text-sm font-bold hover:bg-[#BFA05A]/90 transition">
                            Dashboard
                        </a>
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ url('/register') }}" class="px-4 py-2 bg-[#BFA05A] text-[#17202B] rounded-xl text-sm font-bold hover:bg-[#BFA05A]/90 transition">
                                Get Started
                            </a>
                        @endif
                    @endauth
            ...
            <button onclick="toggleMobileMenu()" class="md:hidden w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center text-white" aria-label="Menu">
        ...
        <div id="mobileMenu" class="hidden md:hidden bg-[#0E1620]/95 backdrop-blur-xl border-t border-white/10 px-6 py-4 space-y-3">
            ...
            <div class="pt-3 border-t border-white/10 space-y-2">
                @guest
                    <a href="{{ url('/login') }}" class="block w-full text-center px-4 py-2.5 bg-white/10 text-white rounded-xl font-bold text-sm">Log in</a>
                    <a href="{{ url('/register') }}" class="block w-full text-center px-4 py-2.5 bg-[#BFA05A] text-[#17202B] rounded-xl font-bold text-sm">Get Started</a>
                @else
                    <a href="{{ url('/dashboard') }}" class="block w-full text-center px-4 py-2.5 bg-[#BFA05A] text-[#17202B] rounded-xl font-bold text-sm">Dashboard</a>
                @endguest
            </div>
        </div>
    </header>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="scroll-reveal">
                <div class="bg-white rounded-2xl overflow-hidden border border-white/10 shadow-xl">
                    <div class="flex">
                        <div class="hidden sm:flex w-16 flex-col items-center py-6 gap-4 bg-[#16283C]">
                            ...
                            <span class="w-8 h-8 rounded-md bg-white/5 text-white/70 text-xs font-bold flex items-center justify-center border border-white/10">D</span>
                            <span class="w-8 h-8 rounded-md bg-white/5 text-white/70 text-xs font-bold flex items-center justify-center border border-white/10">G</span>
                            <span class="w-8 h-8 rounded-md bg-white/5 text-white/70 text-xs font-bold flex items-center justify-center border border-white/10">S</span>
                            <span class="w-8 h-8 rounded-md bg-white/5 text-white/70 text-xs font-bold flex items-center justify-center border border-white/10">T</span>
                            <span class="w-8 h-8 rounded-md bg-[#BFA05A]/25 text-[#D7BC7A] text-xs font-bold flex items-center justify-center border border-[#BFA05A]/40">M</span>
                        </div>
                ...
                <div class="mt-6 flex flex-wrap justify-center gap-2.5">
                    <span class="px-3 py-1.5 rounded-md bg-white/5 border border-white/10 text-white/70 text-xs font-semibold">Live GPS</span>
                    <span class="px-3 py-1.5 rounded-md bg-white/5 border border-white/10 text-white/70 text-xs font-semibold">Knapsack Route Pooling</span>
                    <span class="px-3 py-1.5 rounded-md bg-white/5 border border-white/10 text-white/70 text-xs font-semibold">DA RFO12 Prices</span>
                    <span class="px-3 py-1.5 rounded-md bg-white/5 border border-white/10 text-white/70 text-xs font-semibold">Cost Split + Invoice</span>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    <div class="p-8 sm:p-12 flex flex-col justify-center">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <span class="px-3 py-1.5 rounded-md bg-[#BFA05A]/15 text-[#7C6527] text-xs font-semibold">Radius Matching</span>
                            <span class="px-3 py-1.5 rounded-md bg-[#16283C]/10 text-[#16283C] text-xs font-semibold">Proportional Cost Split</span>
                            <span class="px-3 py-1.5 rounded-md bg-[#16283C]/10 text-[#16283C] text-xs font-semibold">Quick Crop Posting</span>
                        </div>
                    </div>
            ...
            <div id="role-driver" role="tabpanel" aria-labelledby="role-btn-driver" class="role-panel hidden bg-[#F5F6F2] rounded-2xl border border-[#17202B]/5 overflow-hidden">
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    <div class="p-8 sm:p-12 flex flex-col justify-center">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <span class="px-3 py-1.5 rounded-md bg-[#BFA05A]/15 text-[#7C6527] text-xs font-semibold">Mobile PWA</span>
                            <span class="px-3 py-1.5 rounded-md bg-[#16283C]/10 text-[#16283C] text-xs font-semibold">Live Telemetry</span>
                            <span class="px-3 py-1.5 rounded-md bg-[#16283C]/10 text-[#16283C] text-xs font-semibold">Offline Support</span>
                        </div>
                    </div>
                    <div class="bg-[#0E1620] flex items-center justify-center p-8 sm:p-12">
                        <div class="text-center">
                ...
                <div>
                    ...
                    <div class="mt-10 space-y-4">
                        <div class="flex items-center gap-3">
                            <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-md bg-[#16283C]/10 flex items-center justify-center">
    ...
    <footer class="bg-[#0E1620] text-white/60 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-6">
            <div class="flex items-center gap-2.5">
                <div class="w-7 h-7 rounded-md bg-white border border-slate-200 flex items-center justify-center">
