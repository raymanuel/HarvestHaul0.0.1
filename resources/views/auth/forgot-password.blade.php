        ...
        <div style="flex:1; display:flex; align-items:center; justify-content:center; padding:3rem; background:#FAF6ED;">
            <div style="width:100%; max-width:420px;">
                ...
                <div style="margin-bottom:28px;">
                    ...
                    <p style="font-size:13px; color:#8a8a8a; font-weight:500; margin-top:6px;">We'll email you a reset link</p>
                </div>

                @if (session('status'))
                    <div style="margin-bottom:20px; padding:12px 16px; border-radius:12px; background:rgba(58,125,68,0.06); border:1px solid rgba(58,125,68,0.12);">
                        <p style="font-size:13px; color:#3A7D44; font-weight:600;">{{ session('status') }}</p>
                    </div>
                @endif
