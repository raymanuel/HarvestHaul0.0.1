...
<div class="w-full max-w-4xl mx-auto">
    ...
    <header class="pt-8 mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <span class="text-[10px] font-bold uppercase tracking-widest text-harvest-dark dark:text-harvest-light bg-harvest/10 dark:bg-harvest/20 px-3 py-1.5 rounded-lg border border-harvest/10 dark:border-harvest/20 self-start">Settings</span>
        </div>
    </header>
    ...
    <div class="bg-white dark:bg-slate-800 border border-slate-200/70 dark:border-slate-700/80 rounded-2xl shadow-sm p-6 mb-6">
        ...
        <form method="POST" action="{{ route('profile.route-pricing.update') }}">
            ...
            <div class="flex items-end gap-4 flex-wrap">
                ...
                <button type="submit" class="bg-[#16283C] hover:opacity-90 text-white text-xs font-bold px-5 py-2.5 rounded-xl shadow-md transition cursor-pointer">Save Rate</button>
            </div>
    ...
    <div class="bg-white dark:bg-slate-800 border border-slate-200/70 dark:border-slate-700/80 rounded-2xl shadow-sm p-6 mb-6">
        ...
        <div class="mb-5">
            ...
            <p class="text-xs text-slate-700 dark:text-slate-300 font-medium font-mono bg-slate-50 dark:bg-slate-900/60 px-3 py-2 rounded-lg border border-slate-100 dark:border-slate-800">P1.20 / MT / km</p>
        </div>
