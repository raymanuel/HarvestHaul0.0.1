...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('fonts/fonts.css') }}">
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        input:focus-visible { outline: 2px solid #16283C; outline-offset: 2px; }
        ...
        .auth-right { scrollbar-width:none; -ms-overflow-style:none; }
...
<body>
    <div class="auth-split" style="display:flex; min-height:100vh; width:100%; position:relative;">
        ...
        <div class="auth-left" style="flex:1; display:flex; flex-direction:column; justify-content:space-between; padding:3rem 4rem; position:relative; overflow:hidden; background:#0E1620;">
            ...
            {{-- Decorative elements --}}
            <div style="position:absolute; top:-80px; right:-80px; width:300px; height:300px; border-radius:50%; background:radial-gradient(circle, rgba(22, 40, 60,0.12) 0%, transparent 70%);"></div>
            <div style="position:absolute; bottom:-60px; left:-60px; width:250px; height:250px; border-radius:50%; background:radial-gradient(circle, rgba(22, 40, 60,0.08) 0%, transparent 70%);"></div>

            {{-- Top: Logo --}}
            <div style="position:relative; z-index:1; display:flex; align-items:center; gap:10px;">
                <div style="width:36px; height:36px; border-radius:10px; background:#FFFFFF; border:1px solid #E2E8F0; display:flex; align-items:center; justify-content:center;">
            ...
            <div class="auth-left-hero" style="position:relative; z-index:1; max-width:480px;">
                <div style="display:inline-block; padding:4px 14px; border-radius:100px; background:rgba(22, 40, 60,0.15); border:1px solid rgba(22, 40, 60,0.2); margin-bottom:20px;">
                    <span style="font-size:11px; font-weight:700; color:#16283C; letter-spacing:0.04em; text-transform:uppercase;">Mindanao Agri-Logistics</span>
                </div>
            ...
            <div class="float-anim" style="position:absolute; right:60px; bottom:100px; z-index:1; opacity:0.12;">
                <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round" style="filter: drop-shadow(1px 2px 2px rgba(15,46,21,0.45));">
                    <defs>
...
<stop offset="100%" stop-color="#D7BC7A"/>
                    ...
                    <path d="M12 10a4 4 0 014-4h4v4a4 4 0 01-4 4h-4z" fill="url(#pearl-leaf)"/>
                    <path d="M12 14v7" stroke="url(#pearl-stem)" stroke-width="2.2"/>
                ...
                <div id="login-panel" class="panel-slide" style="width:100%; transform:translateX(0); opacity:1;">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:20px;">
                            <label style="display:flex; align-items:center; gap:8px; cursor:pointer; font-size:12px; color:#6a6a6a; font-weight:600;">
                                <input type="checkbox" name="remember" style="width:16px; height:16px; border-radius:4px; border:1.5px solid #d4d2ce; accent-color:#16283C; cursor:pointer;">
                                Remember me
                            </label>
                            <a href="{{ route('password.request') }}" style="font-size:12px; color:#16283C; font-weight:600; text-decoration:none; transition:color 0.2s;"
                               onmouseover="this.style.color='#0E1620'" onmouseout="this.style.color='#16283C'">Forgot password?</a>
                        </div>

                        <button type="submit" id="login-submit" style="width:100%; padding:13px; border:none; border-radius:12px; background:#16283C; color:white; font-size:14px; font-weight:700; cursor:pointer; transition:all 0.2s; font-family:inherit; box-shadow:0 4px 12px rgba(22, 40, 60,0.15);"
                    ...
                    <div style="margin-top:14px; text-align:center;">
                        <a href="/" style="font-size:12px; color:#a0a0a0; text-decoration:none; font-weight:600; transition:color 0.2s;"
                           onmouseover="this.style.color='#16283C'" onmouseout="this.style.color='#a0a0a0'">
                ...
                <div id="register-panel" class="panel-slide" style="position:absolute; top:0; left:0; right:0; transform:translateX(100%); opacity:0; pointer-events:none;">
                        ...
                        <div style="margin-bottom:16px;">
                            <label style="display:flex; align-items:flex-start; gap:10px; cursor:pointer; padding:10px 14px; border-radius:10px; background:#f5f4f1; border:1px solid #e8e5e0;">
                                <input type="checkbox" name="accepted_terms" value="1" {{ old('accepted_terms') ? 'checked' : '' }}
                                    style="margin-top:2px; width:15px; height:15px; border-radius:3px; accent-color:#16283C; cursor:pointer; flex-shrink:0;">
                                <span style="font-size:11px; color:#6a6a6a; line-height:1.5; font-weight:500;">
                                    I agree to the
                                    <a href="{{ route('legal.terms') }}" onclick="event.preventDefault(); openLegalModal('{{ route('legal.terms') }}')" style="color:#16283C; font-weight:700; text-decoration:underline;">Terms</a>
                                    and
                                    <a href="{{ route('legal.privacy') }}" onclick="event.preventDefault(); openLegalModal('{{ route('legal.privacy') }}')" style="color:#16283C; font-weight:700; text-decoration:underline;">Privacy Policy</a>.
                                </span>
                            </label>
                        </div>

                        <button type="submit" style="width:100%; padding:12px; border:none; border-radius:10px; background:#16283C; color:white; font-size:13px; font-weight:700; cursor:pointer; transition:all 0.2s; font-family:inherit; box-shadow:0 4px 12px rgba(22, 40, 60,0.15);"
                            onmouseover="this.style.boxShadow='0 6px 20px rgba(22, 40, 60,0.25)'; this.style.transform='translateY(-1px)'"
                            onmouseout="this.style.boxShadow='0 4px 12px rgba(22, 40, 60,0.15)'; this.style.transform='none'"
                            onmousedown="this.style.transform='translateY(0)'">
                            Create Account
                    ...
                    <div style="margin-top:22px; padding-top:18px; border-top:1px solid #ece9e4; text-align:center;">
                        <span style="font-size:13px; color:#7a7a7a; font-weight:500;">
                            ...
                            <a href="#" onclick="event.preventDefault(); showLogin();" style="color:#16283C; font-weight:700; text-decoration:none; margin-left:4px; transition:color 0.2s;"
                               onmouseover="this.style.color='#0E1620'" onmouseout="this.style.color='#16283C'">Sign in</a>
                        </span>
                    </div>
                </div>
    ...
    <div id="legal-modal-overlay" style="position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.6);display:none;align-items:center;justify-content:center;padding:1rem;backdrop-filter:blur(4px);" onclick="if(event.target===this)closeLegalModal()">
        <div onclick="event.stopPropagation()" style="background:#fff;border-radius:1.5rem;max-width:640px;width:100%;max-height:80vh;overflow-y:auto;position:relative;box-shadow:0 25px 50px -12px rgba(0,0,0,0.3);">
            <div style="position:sticky;top:0;z-index:10;background:#16283C;border-radius:1.5rem 1.5rem 0 0;padding:1.25rem 2rem 1rem;">
