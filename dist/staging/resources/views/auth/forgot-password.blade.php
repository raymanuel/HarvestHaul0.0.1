    ...
    <div class="auth-split" style="display:flex; min-height:100vh; width:100%;">
        ...
        <div style="flex:1; display:flex; align-items:center; justify-content:center; padding:3rem; background:#F5F6F2;">
            <div style="width:100%; max-width:420px;">
                ...
                @if (session('status'))
                    <div style="margin-bottom:20px; padding:12px 16px; border-radius:12px; background:rgba(22, 40, 60,0.06); border:1px solid rgba(22, 40, 60,0.12);">
                        <p style="font-size:13px; color:#16283C; font-weight:600;">{{ session('status') }}</p>
                    </div>
                @endif
