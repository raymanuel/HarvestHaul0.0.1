        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            ...
            >
                @if($totalPendingVerifications > 0)
                    <span class="text-[10px] font-extrabold uppercase tracking-widest text-warning-text bg-warning-bg border border-warning-border px-2 py-0.5 rounded-lg">Action Required</span>
                @endif
            </x-stat-card>
            ...
            @else
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left" aria-label="Activity log">
                        <thead>
                            <tr class="border-b border-slate-150 dark:border-dark-border bg-slate-50/50 dark:bg-slate-900/60">
