<x-layout>
    ...
    <div class="max-w-2xl mx-auto px-4 py-8 space-y-6">
        ...
        <form method="POST" action="{{ route('notifications.preferences.update') }}" class="space-y-3">
            ...
            <div class="pt-2">
                <button type="submit" class="w-full bg-brand hover:bg-brand-dark text-white text-xs font-bold py-2.5 rounded-xl transition-all duration-200 active:scale-[0.98] cursor-pointer">
                    Save Preferences
                </button>
            </div>
        </form>
