<x-layout title="Trip Report — HarvestHaul">
    <div class="w-full max-w-7xl mx-auto pb-12 px-4 sm:px-6 lg:px-8">
        ...
        <!-- Page Header -->
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-slate-800 dark:text-white heading-font">Trip Report</h1>
        </div>

        <!-- Fleet Report Tabs -->
        @php
            $fleetTabs = [
                ['label' => 'Trip Report', 'url' => route('logistics.reports.trips'), 'active' => true],
                ['label' => 'Fuel Ledger', 'url' => route('logistics.analytics'), 'active' => false],
            ];
        @endphp
                        ...
                        <table class="w-full text-xs">
                            <thead>
                                <tr class="text-[10px] font-bold text-slate-400 uppercase tracking-widest border-b border-slate-100 dark:border-slate-700/50">
                                    ...
                                    <th class="text-right py-2 px-3">Net After Fuel</th>
