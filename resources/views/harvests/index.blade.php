...
<div class="w-full">
    ...
    <header class="pt-8 mb-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            @else
                <div class="flex items-center gap-2 bg-gray-100 border border-gray-200 rounded-xl px-5 py-3 self-start sm:self-center">
                    <span class="text-gray-400 text-sm font-semibold">+ Post New Harvest</span>
                    <span class="text-xs bg-amber-100 text-amber-700 border border-amber-200 font-bold px-2 py-0.5 rounded-full whitespace-nowrap">
                        Pending Approval
                    </span>
                </div>
            @endif
                    ...
                    <tr class="hover:bg-slate-50 transition">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @elseif($harvest->status === 'completed')
                                <span class="bg-blue-100 text-blue-700 text-xs font-bold px-3 py-1 rounded-full uppercase">Completed</span>
