...
<div>
    ...
    <div class="relative">
        ...
        @if($isPassword && $showToggle)
            <button type="button" onclick="togglePassword('{{ $inputId }}')" aria-label="Toggle password visibility" class="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition">
